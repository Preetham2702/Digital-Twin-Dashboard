...
export default function Dashboard() {
  ...
  return (
    <div className="h-screen bg-slate-900 text-gray-200 flex flex-col relative">
      ...
      {/* SIDEBAR */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-slate-900 border-r border-slate-700 z-50 transform transition-transform duration-300 ${
      ...
      {/* TOP BAR */}
      <header className="h-14 bg-slate-800 border-b border-slate-700 flex items-center px-6 justify-between">
        ...
        <div className="flex items-center">
          ...
          <span className="ml-6 text-slate-300 font-medium">
